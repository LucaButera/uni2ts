...
class MoiraiPretrainContext(L.LightningModule):
    ...
    def forward(
        ...
        context_mask: Bool[torch.Tensor, "*batch seq_len"],
    ) -> Distribution:
        """
        ...
        :param context_mask: binary mask for context, 1 if part of the context, 0 otherwise
        ...
        def default_train_transform():
            return (
                ...
                + PatchCrop(
                    ...
                    fields=("target",),
                    optional_fields=("past_feat_dynamic_real",),
                    min_context_patches=self.hparams.min_context_patches,
                )
                + PackFields(
                    output_field="target",
                    fields=("target",),
                ...
                + Patchify(
                    ...
                    fields=("target", "observed_mask", "context_mask"),
                    optional_fields=("past_feat_dynamic_real",),
                    reduce_patch_fields=("context_mask",),
                )
                + AddVariateIndex(
                    fields=("target",),
                    optional_fields=("past_feat_dynamic_real",),
